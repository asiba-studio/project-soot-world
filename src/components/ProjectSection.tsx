            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50">
                <div className="flex">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-2 rounded-l-xl transition-all duration-200 ${currentView === '3d'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-2 rounded-r-xl transition-all duration-200 ${currentView === 'list'
                                ? 'bg-blue-500 text-white shadow-sm'
                                : 'text-gray-600 hover:bg-gray-50'
                            }`}
                    >
